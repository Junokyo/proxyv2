...
import PurchasePlaneSection from './PurchasePlan/ScrapPurchasePlaneSection';
import RequestConfigSection from './RequestConfig/RequestConfigSection';
...
const TABS_DATA = [
  ...
  // { value: 'Subaccount', label: 'Sub-account', color: '#14b8a6' },
];

export default function UniverScrapingView() {
