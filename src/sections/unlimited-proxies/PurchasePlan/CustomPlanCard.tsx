  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-slate-200 bg-white px-6 pb-6 pt-6 shadow-sm">
      ...
      <div className="mt-auto pt-6">
        <button className="flex w-full items-center justify-center gap-2 rounded-xl border border-blue-500 bg-blue-50 py-2 text-xs font-semibold text-blue-600 hover:bg-blue-100">
