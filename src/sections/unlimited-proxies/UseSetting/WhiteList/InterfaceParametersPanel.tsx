// InterfaceParametersPanel.tsx
import React from 'react';

export const InterfaceParametersPanel: React.FC = () => {
  return (
    <div className="h-full rounded-2xl border border-slate-200 bg-white px-4 py-4 shadow-sm">
      ...
      <div className="mb-4 overflow-hidden rounded-xl border border-slate-200 text-xs">
        ...
        <table className="w-full border-t border-slate-200 text-left text-[11px]">
