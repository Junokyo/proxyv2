...
import IspUserPassSection from './IspUserPassSection';
import IspWhitelistSection from './IspWhitelistSection';
...
export default function ApiExampleSection() {
  ...
  return (
    <div className="w-full space-y-4">
      ...
      {/* Tab content */}
      <div>
        {currentTab === 'pass' && <IspUserPassSection />}
        {currentTab === 'whitelist' && <IspWhitelistSection />}
      </div>
    </div>
  );
}
