...
import PrivateIpv4WhitelistForm from './PrivateIpv4WhitelistForm';
import PrivateIpv4CodePanel from './PrivateIpv4CodePanel';

export default function PrivateIpv4WhitelistSection() {
  return (
    <div className="grid gap-4 lg:grid-cols-2">
      {/* Main Content */}
      <PrivateIpv4WhitelistForm />

      {/* Sidebar */}
      <div className="flex flex-col gap-3">
        {/* Private IPv4 Info Card */}
