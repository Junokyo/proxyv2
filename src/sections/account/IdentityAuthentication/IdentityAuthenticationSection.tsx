  ...
  return (
    <div className="w-full rounded-2xl bg-white p-4 shadow-sm sm:p-6">
      ...
      <section className="mb-6">
        ...
        <p className="mt-2 text-xs sm:text-sm text-slate-600 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-slate-100 bg-slate-50/80 p-5">
            ...
            <button className="mt-6 rounded-lg bg-blue-500 px-4 py-2 text-xs font-semibold text-white hover:bg-blue-600">
