...
```
cd existing_repo
git remote add origin https://gitlab.com/4zure09/metro-proxy.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/4zure09/metro-proxy/-/settings/integrations)
