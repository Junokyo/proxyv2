...
const ReelsViewBoost: React.FC = () => {
  ...
  return (
    <div className="space-y-3 sm:space-y-4">
      {/* Service Description */}
      <div className="rounded-lg sm:rounded-xl bg-gradient-to-br from-pink-500 to-pink-600 p-4 sm:p-5 text-white shadow-lg">
        <div className="flex items-start gap-2.5 sm:gap-3">
          <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-white/20 flex-shrink-0">
            <Icon icon="mdi:play-circle" className="h-5 w-5 sm:h-6 sm:w-6" />
          </div>
          <div className="flex-1 min-w-0">
            <h3 className="font-semibold text-base sm:text-lg mb-1.5 sm:mb-2">Tăng view reels</h3>
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-slate-300 rounded-lg text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition"
                />
              </div>
